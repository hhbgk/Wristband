...
public class NumberPickerView extends View {
    ...
    // default text's left padding and right padding are both 5dp,
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        switch (mTextGravity){
            case 0:
                mViewCenterX = Math.max(20, (mViewWidth /10.0f + getPaddingLeft()));
                break;
            default:
            case 1:
                ...
                break;
            case 2:
                mViewCenterX = Math.min(w * 4/5.0f, (getPaddingLeft() + mViewWidth + getPaddingRight()));
                break;
        }
        Log.e(tag, "mTextGravity="+mTextGravity + ", mViewCenterX="+ mViewCenterX + ", w="+w);
