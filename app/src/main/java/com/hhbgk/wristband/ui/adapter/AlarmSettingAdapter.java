...
public class AlarmSettingAdapter extends BaseAdapter {
    ...
    public AlarmSettingAdapter(Context context, List<CommonInfo> data) {
        this(context, data, 0, 0);
    }

    public AlarmSettingAdapter(Context context, List<CommonInfo> data, int headerCount) {
        this(context, data, headerCount, 0);
    }

    public AlarmSettingAdapter(Context context, List<CommonInfo> data, int headerCount, int footerCount){
        mData = data;
